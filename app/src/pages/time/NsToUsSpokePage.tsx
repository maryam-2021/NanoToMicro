        ...
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6">
          ...
          <div className="mt-8 rounded-2xl border border-primary/30 bg-primary/10 p-6 text-center">
            ...
            <p className="mt-1 text-xs text-muted-foreground sm:text-sm">
              Visit our central hub to <Link to="/nano-to-micro-conversion/" className="font-bold text-primary underline">understand the universal nano-to-micro relationship</Link> across mass, length, volume, electric current, capacitance, and radiation.
            </p>
          ...
          <RelatedConversions currentSpoke="time" />
        </div>
      </section>
    </>
  );
