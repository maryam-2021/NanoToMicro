# scripts/create_public_structure.py
import os

PUBLIC_DIR = r"C:\Users\marya\.gemini\antigravity\scratch\antigravity-site\public"

# Shared CSS styles for static authority pages
SHARED_CSS = """
:root {
  --bg-primary: #0b0f19;
  --bg-secondary: #131c2e;
...
def make_page(title, meta_desc, breadcrumb_items, content_html):
    bc_html = ' <span style="opacity: 0.5;">/</span> '.join([
...
<head>
  ...
  <title>{title} | NanoToMicro</title>
  <meta name="description" content="{meta_desc}">
  <link rel="canonical" href="https://nanotomicro.com/">
